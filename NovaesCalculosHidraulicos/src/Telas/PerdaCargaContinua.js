...
const PerdaCargaContinua = ({ navigation }) => {
  ...
  // useEffect para manter o nome "Perda de Carga Continua" selecionado no Picker
  useEffect(() => {
          ...
          <View style={styles.modalView}>
            <View style={styles.modalContent}>
              ...
              <Text style={[styles.modalText, styles.formula]}>
                ℎ𝑓 = (10,643 ∗𝑄^1,852) ________________________ (𝐶^1,852 ∗
                𝐷^4,87 )
              </Text>
