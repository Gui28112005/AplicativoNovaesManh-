          ...
          >
            <View style={styles.modalView}>
              <View style={styles.modalContent}>
                <Text style={styles.modalTitle}>Calculo Perimetro</Text>
                <Text style={styles.modalText}></Text>
                <Text style={styles.modalText}>
                  O perímetro é uma medida que descreve o comprimento de uma
                  figura geométrica. Por favor, insira o valor do raio do
                  círculo para calcular sua área.
                </Text>
                <TouchableOpacity
