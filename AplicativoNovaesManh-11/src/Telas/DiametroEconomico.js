          ...
          <View style={styles.modalView}>
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                Informações sobre o cálculo do diâmetro econômico
              </Text>
              <Text style={styles.modalText}>
                Aqui você pode fornecer informações detalhadas sobre como
                calcular o diâmetro econômico e o que ele representa.
              </Text>
              <TouchableOpacity
